...
public class ContentListAdapter extends RecyclerView.Adapter<ContentListAdapter.MyViewHolder> {
    ...
    public ContentListAdapter(Context mContext, ArrayList<HashMap<String,String>> mList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        Log.i(TAG, "onCreateViewHolder: "+mList);
        return holder;
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mNumber.setText(mList.get(position).get("phone"));
